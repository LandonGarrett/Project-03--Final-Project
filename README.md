# Sustainable Homestead Resource Website
...
## Website Files
- `index.html` — Homepage introducing the project topic  
- `about.html` — Secondary page with additional context  
- `style.css` — External stylesheet for consistent styling

This repository serves as a complete example of managing a small digital project from concept to completion.
